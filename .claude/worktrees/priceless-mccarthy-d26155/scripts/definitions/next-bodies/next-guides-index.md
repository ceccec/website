# Guides index (App Router)

Official hub: **[Guides](https://nextjs.org/docs/app/guides)**. Use this file to jump to a guide without scanning the whole sidebar. Pair with **`next-basics.mdc`** and topic rules.
...
- [Analytics / Speed Insights](https://nextjs.org/docs/app/guides/analytics)
- [OpenTelemetry](https://nextjs.org/docs/app/guides/open-telemetry)

## Progressive web & static
...
- [Testing](https://nextjs.org/docs/app/guides/testing) — [Cypress](https://nextjs.org/docs/app/guides/testing/cypress), [Jest](https://nextjs.org/docs/app/guides/testing/jest), [Playwright](https://nextjs.org/docs/app/guides/testing/playwright), [Vitest](https://nextjs.org/docs/app/guides/testing/vitest)

## Migration & upgrades

- [Migrating](https://nextjs.org/docs/app/guides/migrating) — [App Router](https://nextjs.org/docs/app/guides/migrating/app-router-migration), [CRA](https://nextjs.org/docs/app/guides/migrating/from-create-react-app), [Vite](https://nextjs.org/docs/app/guides/migrating/from-vite)
- [Upgrading](https://nextjs.org/docs/app/guides/upgrading) — [Codemods](https://nextjs.org/docs/app/guides/upgrading/codemods), [v14](https://nextjs.org/docs/app/guides/upgrading/version-14), [v15](https://nextjs.org/docs/app/guides/upgrading/version-15), [v16](https://nextjs.org/docs/app/guides/upgrading/version-16)
...
**More:** **`next-features-overview.mdc`** · **`next-deployment.mdc`**
