...
import { resolveBooleanGlobalField, resolveGlobalField } from './resolveGlobalField'
...
/** Client fallback when `SitePublicConfigProvider` is absent — env-only, same merge rules as server. */
