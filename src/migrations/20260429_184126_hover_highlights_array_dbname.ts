...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`co_callout_fields_images\` (
  	\`_order\` integer NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`co_callout_fields_images_order_idx\` ON \`co_callout_fields_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`co_callout_fields_images_parent_id_idx\` ON \`co_callout_fields_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`co_callout_fields_images_image_idx\` ON \`co_callout_fields_images\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`co\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`co_order_idx\` ON \`co\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`co_parent_id_idx\` ON \`co\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`co_path_idx\` ON \`co\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`co_callout_fields_callout_fields_logo_idx\` ON \`co\` (\`callout_fields_logo_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`csc_case_study_card_fields_cards\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`csc_case_study_card_fields_cards_order_idx\` ON \`csc_case_study_card_fields_cards\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`csc_case_study_card_fields_cards_parent_id_idx\` ON \`csc_case_study_card_fields_cards\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`csc_case_study_card_fields_cards_case_study_idx\` ON \`csc_case_study_card_fields_cards\` (\`case_study_id\`);`)
  await db.run(sql`CREATE TABLE \`csc\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`csc_order_idx\` ON \`csc\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`csc_parent_id_idx\` ON \`csc\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`csc_path_idx\` ON \`csc\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`csh\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`csh_order_idx\` ON \`csh\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`csh_parent_id_idx\` ON \`csh\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`csh_path_idx\` ON \`csh\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`csp_case_study_parallax_fields_items_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`image_id\` integer NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`csp_case_study_parallax_fields_items_images_order_idx\` ON \`csp_case_study_parallax_fields_items_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`csp_case_study_parallax_fields_items_images_parent_id_idx\` ON \`csp_case_study_parallax_fields_items_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`csp_case_study_parallax_fields_items_images_image_idx\` ON \`csp_case_study_parallax_fields_items_images\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`csp_case_study_parallax_fields_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`quote\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`csp_case_study_parallax_fields_items_order_idx\` ON \`csp_case_study_parallax_fields_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`csp_case_study_parallax_fields_items_parent_id_idx\` ON \`csp_case_study_parallax_fields_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`csp_case_study_parallax_fields_items_logo_idx\` ON \`csp_case_study_parallax_fields_items\` (\`logo_id\`);`)
  await db.run(sql`CREATE INDEX \`csp_case_study_parallax_fields_items_case_study_idx\` ON \`csp_case_study_parallax_fields_items\` (\`case_study_id\`);`)
  await db.run(sql`CREATE TABLE \`csp\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`csp_order_idx\` ON \`csp\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`csp_parent_id_idx\` ON \`csp\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`csp_path_idx\` ON \`csp\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`cdf_code_feature_fields_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`link_type\` text DEFAULT 'reference',
  ...
  `)
  await db.run(sql`CREATE INDEX \`cdf_code_feature_fields_links_order_idx\` ON \`cdf_code_feature_fields_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`cdf_code_feature_fields_links_parent_id_idx\` ON \`cdf_code_feature_fields_links\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`cdf_code_feature_fields_code_tabs_code_blips\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`row\` numeric NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`cdf_code_feature_fields_code_tabs_code_blips_order_idx\` ON \`cdf_code_feature_fields_code_tabs_code_blips\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`cdf_code_feature_fields_code_tabs_code_blips_parent_id_idx\` ON \`cdf_code_feature_fields_code_tabs_code_blips\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`cdf_code_feature_fields_code_tabs\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`cdf_code_feature_fields_code_tabs_order_idx\` ON \`cdf_code_feature_fields_code_tabs\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`cdf_code_feature_fields_code_tabs_parent_id_idx\` ON \`cdf_code_feature_fields_code_tabs\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`cdf\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`cdf_order_idx\` ON \`cdf\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`cdf_parent_id_idx\` ON \`cdf\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`cdf_path_idx\` ON \`cdf\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`cmp_comparison_table_fields_rows\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`feature\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`cmp_comparison_table_fields_rows_order_idx\` ON \`cmp_comparison_table_fields_rows\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`cmp_comparison_table_fields_rows_parent_id_idx\` ON \`cmp_comparison_table_fields_rows\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`cmp\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`cmp_order_idx\` ON \`cmp\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`cmp_parent_id_idx\` ON \`cmp\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`cmp_path_idx\` ON \`cmp\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`cgr_content_grid_fields_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`link_type\` text DEFAULT 'reference',
  ...
  `)
  await db.run(sql`CREATE INDEX \`cgr_content_grid_fields_links_order_idx\` ON \`cgr_content_grid_fields_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`cgr_content_grid_fields_links_parent_id_idx\` ON \`cgr_content_grid_fields_links\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`cgr_content_grid_fields_cells\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`cgr_content_grid_fields_cells_order_idx\` ON \`cgr_content_grid_fields_cells\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`cgr_content_grid_fields_cells_parent_id_idx\` ON \`cgr_content_grid_fields_cells\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`cgr\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`cgr_order_idx\` ON \`cgr\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`cgr_parent_id_idx\` ON \`cgr\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`cgr_path_idx\` ON \`cgr\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`hhl_highlight_rows\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`text\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`hhl_highlight_rows_order_idx\` ON \`hhl_highlight_rows\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`hhl_highlight_rows_parent_id_idx\` ON \`hhl_highlight_rows\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`hhl_highlight_rows_media_media_top_idx\` ON \`hhl_highlight_rows\` (\`media_top_id\`);`)
  await db.run(sql`CREATE INDEX \`hhl_highlight_rows_media_media_bottom_idx\` ON \`hhl_highlight_rows\` (\`media_bottom_id\`);`)
  await db.run(sql`CREATE TABLE \`hhl\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`hhl_order_idx\` ON \`hhl\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`hhl_parent_id_idx\` ON \`hhl\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`hhl_path_idx\` ON \`hhl\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`mb\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`mb_order_idx\` ON \`mb\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`mb_parent_id_idx\` ON \`mb\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`mb_path_idx\` ON \`mb\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`mb_media_block_fields_media_block_fields_media_idx\` ON \`mb\` (\`media_block_fields_media_id\`);`)
  await db.run(sql`CREATE TABLE \`mcnt_media_content_fields_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`image_id\` integer NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`mcnt_media_content_fields_images_order_idx\` ON \`mcnt_media_content_fields_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`mcnt_media_content_fields_images_parent_id_idx\` ON \`mcnt_media_content_fields_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`mcnt_media_content_fields_images_image_idx\` ON \`mcnt_media_content_fields_images\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`mcnt\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`mcnt_order_idx\` ON \`mcnt\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`mcnt_parent_id_idx\` ON \`mcnt\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`mcnt_path_idx\` ON \`mcnt\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`mca_media_content_accordion_fields_accordion\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`mca_media_content_accordion_fields_accordion_order_idx\` ON \`mca_media_content_accordion_fields_accordion\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`mca_media_content_accordion_fields_accordion_parent_id_idx\` ON \`mca_media_content_accordion_fields_accordion\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`mca_media_content_accordion_fields_accordion_media_idx\` ON \`mca_media_content_accordion_fields_accordion\` (\`media_id\`);`)
  await db.run(sql`CREATE TABLE \`mca\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`mca_order_idx\` ON \`mca\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`mca_parent_id_idx\` ON \`mca\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`mca_path_idx\` ON \`mca\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`tiers\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`name\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`tiers_order_idx\` ON \`tiers\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`tiers_parent_id_idx\` ON \`tiers\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`prc\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`prc_order_idx\` ON \`prc\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`prc_parent_id_idx\` ON \`prc\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`prc_path_idx\` ON \`prc\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`stm_statement_fields_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`link_type\` text DEFAULT 'reference',
  ...
  `)
  await db.run(sql`CREATE INDEX \`stm_statement_fields_links_order_idx\` ON \`stm_statement_fields_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`stm_statement_fields_links_parent_id_idx\` ON \`stm_statement_fields_links\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`stm\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`stm_order_idx\` ON \`stm\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`stm_parent_id_idx\` ON \`stm\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`stm_path_idx\` ON \`stm\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`stm_statement_fields_statement_fields_media_idx\` ON \`stm\` (\`statement_fields_media_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`rows_code_blips\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`row\` numeric,
  ...
  `)
  await db.run(sql`CREATE INDEX \`rows_code_blips_order_idx\` ON \`rows_code_blips\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`rows_code_blips_parent_id_idx\` ON \`rows_code_blips\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`rows\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`rich_text\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`rows_order_idx\` ON \`rows\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`rows_parent_id_idx\` ON \`rows\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`rows_media_idx\` ON \`rows\` (\`media_id\`);`)
  await db.run(sql`CREATE TABLE \`shl\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`shl_order_idx\` ON \`shl\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`shl_parent_id_idx\` ON \`shl\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`shl_path_idx\` ON \`shl\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_co_v_callout_fields_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_co_v_callout_fields_images_order_idx\` ON \`_co_v_callout_fields_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_co_v_callout_fields_images_parent_id_idx\` ON \`_co_v_callout_fields_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_co_v_callout_fields_images_image_idx\` ON \`_co_v_callout_fields_images\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_co_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_co_v_order_idx\` ON \`_co_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_co_v_parent_id_idx\` ON \`_co_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_co_v_path_idx\` ON \`_co_v\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_co_v_callout_fields_callout_fields_logo_idx\` ON \`_co_v\` (\`callout_fields_logo_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_csc_v_case_study_card_fields_cards\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`rich_text\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_csc_v_case_study_card_fields_cards_order_idx\` ON \`_csc_v_case_study_card_fields_cards\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_csc_v_case_study_card_fields_cards_parent_id_idx\` ON \`_csc_v_case_study_card_fields_cards\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_csc_v_case_study_card_fields_cards_case_study_idx\` ON \`_csc_v_case_study_card_fields_cards\` (\`case_study_id\`);`)
  await db.run(sql`CREATE TABLE \`_csc_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_csc_v_order_idx\` ON \`_csc_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_csc_v_parent_id_idx\` ON \`_csc_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_csc_v_path_idx\` ON \`_csc_v\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_csh_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_csh_v_order_idx\` ON \`_csh_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_csh_v_parent_id_idx\` ON \`_csh_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_csh_v_path_idx\` ON \`_csh_v\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_csp_v_case_study_parallax_fields_items_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_csp_v_case_study_parallax_fields_items_images_order_idx\` ON \`_csp_v_case_study_parallax_fields_items_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_csp_v_case_study_parallax_fields_items_images_parent_id_idx\` ON \`_csp_v_case_study_parallax_fields_items_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_csp_v_case_study_parallax_fields_items_images_image_idx\` ON \`_csp_v_case_study_parallax_fields_items_images\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_csp_v_case_study_parallax_fields_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`quote\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_csp_v_case_study_parallax_fields_items_order_idx\` ON \`_csp_v_case_study_parallax_fields_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_csp_v_case_study_parallax_fields_items_parent_id_idx\` ON \`_csp_v_case_study_parallax_fields_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_csp_v_case_study_parallax_fields_items_logo_idx\` ON \`_csp_v_case_study_parallax_fields_items\` (\`logo_id\`);`)
  await db.run(sql`CREATE INDEX \`_csp_v_case_study_parallax_fields_items_case_study_idx\` ON \`_csp_v_case_study_parallax_fields_items\` (\`case_study_id\`);`)
  await db.run(sql`CREATE TABLE \`_csp_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_csp_v_order_idx\` ON \`_csp_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_csp_v_parent_id_idx\` ON \`_csp_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_csp_v_path_idx\` ON \`_csp_v\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_cdf_v_code_feature_fields_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`link_type\` text DEFAULT 'reference',
  ...
  `)
  await db.run(sql`CREATE INDEX \`_cdf_v_code_feature_fields_links_order_idx\` ON \`_cdf_v_code_feature_fields_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_cdf_v_code_feature_fields_links_parent_id_idx\` ON \`_cdf_v_code_feature_fields_links\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_cdf_v_code_feature_fields_code_tabs_code_blips\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`row\` numeric,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_cdf_v_code_feature_fields_code_tabs_code_blips_order_idx\` ON \`_cdf_v_code_feature_fields_code_tabs_code_blips\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_cdf_v_code_feature_fields_code_tabs_code_blips_parent_id_idx\` ON \`_cdf_v_code_feature_fields_code_tabs_code_blips\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_cdf_v_code_feature_fields_code_tabs\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`language\` text DEFAULT 'none',
  ...
  `)
  await db.run(sql`CREATE INDEX \`_cdf_v_code_feature_fields_code_tabs_order_idx\` ON \`_cdf_v_code_feature_fields_code_tabs\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_cdf_v_code_feature_fields_code_tabs_parent_id_idx\` ON \`_cdf_v_code_feature_fields_code_tabs\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_cdf_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_cdf_v_order_idx\` ON \`_cdf_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_cdf_v_parent_id_idx\` ON \`_cdf_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_cdf_v_path_idx\` ON \`_cdf_v\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_cgr_v_content_grid_fields_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`link_type\` text DEFAULT 'reference',
  ...
  `)
  await db.run(sql`CREATE INDEX \`_cgr_v_content_grid_fields_links_order_idx\` ON \`_cgr_v_content_grid_fields_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_cgr_v_content_grid_fields_links_parent_id_idx\` ON \`_cgr_v_content_grid_fields_links\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_cgr_v_content_grid_fields_cells\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`content\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_cgr_v_content_grid_fields_cells_order_idx\` ON \`_cgr_v_content_grid_fields_cells\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_cgr_v_content_grid_fields_cells_parent_id_idx\` ON \`_cgr_v_content_grid_fields_cells\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_cgr_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_cgr_v_order_idx\` ON \`_cgr_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_cgr_v_parent_id_idx\` ON \`_cgr_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_cgr_v_path_idx\` ON \`_cgr_v\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_hhl_highlight_rows_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`text\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_hhl_highlight_rows_v_order_idx\` ON \`_hhl_highlight_rows_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_hhl_highlight_rows_v_parent_id_idx\` ON \`_hhl_highlight_rows_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_hhl_highlight_rows_v_media_media_top_idx\` ON \`_hhl_highlight_rows_v\` (\`media_top_id\`);`)
  await db.run(sql`CREATE INDEX \`_hhl_highlight_rows_v_media_media_bottom_idx\` ON \`_hhl_highlight_rows_v\` (\`media_bottom_id\`);`)
  await db.run(sql`CREATE TABLE \`_hhl_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_hhl_v_order_idx\` ON \`_hhl_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_hhl_v_parent_id_idx\` ON \`_hhl_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_hhl_v_path_idx\` ON \`_hhl_v\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_mb_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_mb_v_order_idx\` ON \`_mb_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_mb_v_parent_id_idx\` ON \`_mb_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_mb_v_path_idx\` ON \`_mb_v\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_mb_v_media_block_fields_media_block_fields_media_idx\` ON \`_mb_v\` (\`media_block_fields_media_id\`);`)
  await db.run(sql`CREATE TABLE \`_mcnt_v_media_content_fields_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_mcnt_v_media_content_fields_images_order_idx\` ON \`_mcnt_v_media_content_fields_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_mcnt_v_media_content_fields_images_parent_id_idx\` ON \`_mcnt_v_media_content_fields_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_mcnt_v_media_content_fields_images_image_idx\` ON \`_mcnt_v_media_content_fields_images\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_mcnt_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_mcnt_v_order_idx\` ON \`_mcnt_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_mcnt_v_parent_id_idx\` ON \`_mcnt_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_mcnt_v_path_idx\` ON \`_mcnt_v\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_mca_v_media_content_accordion_fields_accordion\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`position\` text DEFAULT 'normal',
  ...
  `)
  await db.run(sql`CREATE INDEX \`_mca_v_media_content_accordion_fields_accordion_order_idx\` ON \`_mca_v_media_content_accordion_fields_accordion\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_mca_v_media_content_accordion_fields_accordion_parent_id_idx\` ON \`_mca_v_media_content_accordion_fields_accordion\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_mca_v_media_content_accordion_fields_accordion_media_idx\` ON \`_mca_v_media_content_accordion_fields_accordion\` (\`media_id\`);`)
  await db.run(sql`CREATE TABLE \`_mca_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_mca_v_order_idx\` ON \`_mca_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_mca_v_parent_id_idx\` ON \`_mca_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_mca_v_path_idx\` ON \`_mca_v\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_feats_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`icon\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_feats_v_order_idx\` ON \`_feats_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_feats_v_parent_id_idx\` ON \`_feats_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_tiers_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`name\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_tiers_v_order_idx\` ON \`_tiers_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_tiers_v_parent_id_idx\` ON \`_tiers_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_prc_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_prc_v_order_idx\` ON \`_prc_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_prc_v_parent_id_idx\` ON \`_prc_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_prc_v_path_idx\` ON \`_prc_v\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_stm_v_statement_fields_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`link_type\` text DEFAULT 'reference',
  ...
  `)
  await db.run(sql`CREATE INDEX \`_stm_v_statement_fields_links_order_idx\` ON \`_stm_v_statement_fields_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_stm_v_statement_fields_links_parent_id_idx\` ON \`_stm_v_statement_fields_links\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_stm_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_stm_v_order_idx\` ON \`_stm_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_stm_v_parent_id_idx\` ON \`_stm_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_stm_v_path_idx\` ON \`_stm_v\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_stm_v_statement_fields_statement_fields_media_idx\` ON \`_stm_v\` (\`statement_fields_media_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_rows_v_code_blips\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`row\` numeric,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_rows_v_code_blips_order_idx\` ON \`_rows_v_code_blips\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_rows_v_code_blips_parent_id_idx\` ON \`_rows_v_code_blips\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_rows_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`rich_text\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_rows_v_order_idx\` ON \`_rows_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_rows_v_parent_id_idx\` ON \`_rows_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_rows_v_media_idx\` ON \`_rows_v\` (\`media_id\`);`)
  await db.run(sql`CREATE TABLE \`_shl_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_shl_v_order_idx\` ON \`_shl_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_shl_v_parent_id_idx\` ON \`_shl_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_shl_v_path_idx\` ON \`_shl_v\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_case_studies_v_snapshot_idx\` ON \`_case_studies_v\` (\`snapshot\`);`)
  await db.run(sql`CREATE INDEX \`_case_studies_v_published_locale_idx\` ON \`_case_studies_v\` (\`published_locale\`);`)
  await db.run(sql`CREATE INDEX \`_case_studies_v_latest_idx\` ON \`_case_studies_v\` (\`latest\`);`)
  await db.run(sql`CREATE TABLE \`_case_studies_v_locales\` (
  ...
  `)
  await db.run(sql`CREATE INDEX \`_case_studies_v_version_meta_version_meta_image_idx\` ON \`_case_studies_v_locales\` (\`version_meta_image_id\`,\`_locale\`);`)
  await db.run(sql`CREATE UNIQUE INDEX \`_case_studies_v_locales_locale_parent_id_unique\` ON \`_case_studies_v_locales\` (\`_locale\`,\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_partners_v_snapshot_idx\` ON \`_partners_v\` (\`snapshot\`);`)
  await db.run(sql`CREATE INDEX \`_partners_v_published_locale_idx\` ON \`_partners_v\` (\`published_locale\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_cmp_v_comparison_table_fields_rows\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`feature\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_cmp_v_comparison_table_fields_rows_order_idx\` ON \`_cmp_v_comparison_table_fields_rows\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_cmp_v_comparison_table_fields_rows_parent_id_idx\` ON \`_cmp_v_comparison_table_fields_rows\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_cmp_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_cmp_v_order_idx\` ON \`_cmp_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_cmp_v_parent_id_idx\` ON \`_cmp_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_cmp_v_path_idx\` ON \`_cmp_v\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`admin_settings\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE TABLE \`get_started_locales\` (
  	\`meta_title\` text,
  	\`meta_description\` text,
  	\`meta_image_id\` integer,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`get_started_meta_meta_image_idx\` ON \`get_started_locales\` (\`meta_image_id\`,\`_locale\`);`)
  await db.run(sql`CREATE UNIQUE INDEX \`get_started_locales_locale_parent_id_unique\` ON \`get_started_locales\` (\`_locale\`,\`_parent_id\`);`)
